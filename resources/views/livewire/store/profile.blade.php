...
<div class="flex flex-col">
    ...
    <div class="flex justify-center gap-x-10 mx-20 mt-12 rounded">
        <div class="flex flex-col items-center bg-white shadow py-10 p-16">
            @if ($user->image)
        ...
        <div class="flex shadow flex-col bg-white px-16 p-10">
            ...
            <div class="flex gap-x-10 my-10">
                ...
                @if ($isEdit)
                    <input type="text" class="input input-bordered input-sm w-40"
                        placeholder="Masukkan No Telepon Anda" wire:model='phone_number' value="{{ $phone_number }}">
                @else
                    <div class="flex justify-center items-center gap-x-1">
                        <img src="https://img.icons8.com/ios-filled/50/4D4D4D/marker.png" alt=""
                            class="h-5 w-5">
