...
@section('adminpage')
    <div class="flex flex-col mt-5 mr-3 gap-y-5">
        ...
        <form method="POST" wire:submit.prevent='store' class="flex flex-col p-10 py-5 bg-white rounded-lg shadow gap-y-2">
            ...
            <input type="text" name="name" wire:model="name" value="{{ $name }}"
                placeholder="Masukkan Nama Produk" class="input input-bordered">
            ...
            <input name="description" wire:model='description' placeholder="Masukkan Deskripsi Produk"
            ...
            <div class="flex items-center my-3 gap-x-3">
                <button type="submit" class="btn btn-sm btn-neutral">Simpan</button>
